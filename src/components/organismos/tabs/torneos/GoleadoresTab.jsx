...
export const GoleadoresTab = ({
  ...
  // revisa si al menos 1 jugador tiene foto
            ...
            <tbody>
              {goleadores.map((jugador, index) => {
                ...
                return (
                  ...
                  >
                    <RankTd>
                      <RankBadge $pos={index + 1} title={`Posición ${index + 1}`}>
                        {index + 1}
                      </RankBadge>
                    </RankTd>
...
const RankBadge = styled.div`
  ...
  ${({ $pos }) => {
    ...
    if ($pos === 2) {
      return `
        background: linear-gradient(180deg,#e6eaf0 0%, #c6ccd6 100%);
        color: rgba(0,0,0,0.85);
        border: 1px solid rgba(0,0,0,0.06);
      `;
    }
    if ($pos === 3) {
      return `
        background: linear-gradient(180deg,#d7a17a 0%, #b97745 100%);
        color: rgba(0,0,0,0.85);
        border: 1px solid rgba(0,0,0,0.06);
      `;
    }
