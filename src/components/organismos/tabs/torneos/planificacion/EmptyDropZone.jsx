    ...
    return (
        <Container $isConfirmed={isConfirmed} $isDragOver={isDragOver}>
            <div className="icon-wrapper">
                {isConfirmed ? <RiCalendarCheckLine size={45} /> : <RiDragDropLine size={45} />}
            </div>
            <h3>{isConfirmed ? "Jornada sin partidos" : "Planilla vacía"}</h3>
            <p>
                {isConfirmed 
                    ? "Esta jornada ha sido confirmada sin ningún partido programado." 
...
const Container = styled.div`
    ...
    /* EFECTO CUANDO SE ARRASTRA UN PARTIDO ENCIMA */
