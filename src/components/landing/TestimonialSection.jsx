...
const TESTIMONIALS = [
  {
    quote: "Con Bracket App dejamos atrás las hojas de cálculo y ahora Green Sport tiene calendario, resultados y tabla en un solo lugar. Los equipos siempre saben qué sigue.",
  ...
  {
    quote: "Administrar la Liga Municipal de Futbol de Xicotepec es mucho más sencillo desde que centralizamos las jornadas y las estadísticas. La información está disponible para todos en tiempo real.",
    author: "Leopoldo Rodriguez",
    role: "Administrador de Liga",
    league: "Liga Municipal de Futbol de Xicotepec",
    teams: 24,
    seasons: 5,
    stars: 5,
  },
  {
    quote: "En la Liga Municipal de Futbol Rapido de Huauchinango ahora publicamos resultados y posiciones sin trabajo duplicado. Los delegados tienen toda la jornada a la mano.",
    author: "Rafael Cruz",
    role: "Administrador de Liga",
    league: "Liga Municipal de Futbol Rapido de Huauchinango",
    teams: 16,
    seasons: 3,
    stars: 5,
  },
