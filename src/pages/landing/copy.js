export const landingCopy = {
  ...
  functions: [
    ...
    { title: "Equipos", text: "Registrar equipos, jugadores, plantillas y cambios operativos." },
    { title: "Partidos", text: "Programar jornadas, capturar resultados y administrar cedulas." },
    { title: "Tablas publicas", text: "Compartir standings, goleadores y calendarios con enlaces publicos." },
    { title: "Managers", text: "Gestionar accesos y acciones de administradores o responsables de equipo." },
  ],
  flow: [
    { title: "Configurar", text: "Definir liga, divisiones, equipos y reglas base." },
